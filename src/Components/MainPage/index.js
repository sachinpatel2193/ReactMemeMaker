      ...
      <div>
        <div className="main-content">
          <div className="sidebar">
            <NavbarBrand href="/">Sachin's Meme Generator</NavbarBrand>
            <img id="trollface" src = "/images/Trollface.png" alt="Trollface"></img>
            <p>
              Developed using ReactJs. Also have this web app as Mobile app for android and ios.
            </p>
            <p>
              You can add top and bottom text to a meme-template, move the text around and can save the image by downloading it. As well as, share it on whatsapp, facebook and instagram.
            </p>
          </div>
